    ...
    <header className="relative h-20 p-1 md:p-2 text-white" aria-label="primary navigation" >
        <div className="relative flex ">
          ...
          <div className="flex min-w-fit h-full">
            <Link href="/" className="pt-2 md:pt-0 flex items-center" ><img src="/apello-01-05.png" alt="logo" className="h-10  object-cover"   /> <h2 className="text-xl ml-0 font-bold  uppercase ">Apello</h2></Link>
          </div>
          ...
          <div className="fixed right-0.5 bottom-4 z-50 flex flex-col gap-y-2 text-[#c4c4c4] " aria-label="social media section">        
            ...
            <a href="f" className="px-1 lg:px-3 "><FaTwitter size={20} className='cursor-pointer hover:scale-110 hover:text-white' /></a>
