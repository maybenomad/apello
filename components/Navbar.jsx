...
const Navbar = () => {
  ...
  return (
    <header
      className="flex items-center relative h-20 p-1 md:p-2 gap-x-4 text-white border-b border-bwhite"
    ...
    >
      <div className="flex min-w-fit h-full">
        <Link href="/" className="pt-2 md:pt-0 flex items-center">
          <img
            ...
            style={{ top: "-2px" }}
          />
          {/* <img src="/lyre-08.png" alt="logo" className="h-16 object-cover" />{" "}
          <h2 className="text-3xl ml-0 font-bold tracking-widest uppercase ">
            Apello
          </h2> */}
        </Link>
      </div>
      ...
      <ul
        className={`ml-auto flex justify-center items-center uppercase gap-x-3 ${
          menuOpen ? "translate-x-0 " : "-translate-x-full bg-transparent"
        }  md:translate-x-0 ease-in-out duration-300`}
      >
        <li className="box-border text-xl ml-0 font-bold">
          <Link
            href="/holder"
            onClick={toggleClick}
            className="p-1 focus:outline-none focus-visible:ring-4 ring-violet rounded-xl pb-3 pt-3 selected"
          >
            Holders
          </Link>
        </li>
        <li className="group relative ml-0 font-bold  ">
          <div className="group-hover:text-apello cursor-pointer flex items-center gap-1 text-xl p-1 pb-3 pt-3 focus:outline-none focus-visible:ring-4 ring-violet rounded-xl pb-3  ">
        ...
        <li className="text-xl font-bold">
          <Link
            ...
            onClick={toggleClick}
            className="hover:text-apello p-1 focus:outline-none focus-visible:ring-4 ring-violet rounded-full pb-3 pt-3 selected"
          >
            Image Creator
          </Link>
        </li>
        <li className="text-xl font-bold group-hover:text-violet">
          <Link
            href="#"
            onClick={toggleClick}
            className=" p-1 focus:outline-none focus-visible:ring-4 ring-violet rounded-full pb-3 pt-3 selected selected-dis"
          >
            Snapshot
          </Link>
        </li>
