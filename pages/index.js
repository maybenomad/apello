                    ...
                    { botModalOpen && <Modal title="invite bot" isOpen={botModalOpen} handleClose={() => setBotModalOpen(!botModalOpen)} >
                      <div className="flex flex-col justify-between mx-auto">
                        <div className="flex flex-col justify-center items-center py-8 gap-y-4 ">
                          ...
                          <a href='https://discord.com/api/oauth2/authorize?client_id=1047250675324690592&permissions=268527680&scope=bot' target="_blank" rel="noopener noreferrer" className=" px-3 py-3 w-60 bg-black rounded text-base font-medium uppercase tracking-wide text-center  text-white px-2 py-3  hover:cursor-pointer focus:outline-none focus-visible:ring-2 ring-blanc shadow-[inset_0_0_0_rgba(108,99,255,0.6)] ease-out duration-700 hover:shadow-[inset_240px_0_0_rgba(108,99,255,0.99)] border-solid border-violet border-2">apello token gating</a>
                          <a href='https://bit.ly/ApelloSalesTracker' target="_blank" rel="noopener noreferrer" className=" px-3 py-3 w-60 bg-black rounded text-base font-medium uppercase tracking-wide text-center  text-white px-2 py-3  hover:cursor-pointer focus:outline-none focus-visible:ring-2 ring-blanc shadow-[inset_0_0_0_rgba(108,99,255,0.6)] ease-out duration-700 hover:shadow-[inset_240px_0_0_rgba(108,99,255,0.99)] border-solid border-violet border-2">apello sales tracker</a>
                        </div>
                      </div>  
                    </Modal>}
                    <a href='https://apello.gitbook.io/apello' target="_blank" rel="license noreferrer" className=" block max-w-fit bg-black rounded text-base font-medium uppercase tracking-wide text-center  text-white px-2 py-3  hover:cursor-pointer focus:outline-none focus-visible:ring-2 ring-blanc  my-9 shadow-[inset_0_0_0_rgba(108,99,255,0.6)] ease-out duration-500 hover:shadow-[inset_144.4px_0_0_rgba(108,99,255,0.99)] border-solid border-violet border-2">Apello Docs</a>
                  </div>
