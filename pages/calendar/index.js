...
const Calendar = () => {
    ...
    const url = `https://apello-api.xyz:4000/api/calendar?${status==="upcoming" ? "upcoming= &" : "&"}name=${query}${chain!=="all chains" ? "&chain="+chain : ""}`;
    ...
    return ( 
        <section className="container mx-auto " aria-label="calendar section">
            <div className="flex flex-col-reverse md:flex-row justify-between gap-3" aria-label="search fields">
                <div className="flex items-center gap-x-2 border border-[#2d2d2d] focus-within:border-[#8b949e] rounded-3xl w-full md:w-fit md:max-w-sm h-12 px-4 ">
                    ...
                    <div className="flex relative h-full border-l border-[#2d2d2d] pl-4">
                        <button className="flex items-center gap-x-1 capitalize peer" >
                            {status}
                        ...
                        <div aria-label="drop_down" className={`hidden peer-focus:block hover:block bg-noir text-[#8b949e] overflow-visible w-auto absolute top-12 left-0 py-3 rounded shadow  z-20 `} >
                ...
                <div className="flex relative h-full rounded-3xl border border-[#2d2d2d] focus-within:border-[#8b949e] py-2 px-3 ">
                    <button className="flex items-center gap-x-1 capitalize peer" >
                        {chain}
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 text-[#8b949e]">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
